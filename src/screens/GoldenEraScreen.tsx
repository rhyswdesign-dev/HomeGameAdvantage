...
const GoldenEraScreen: React.FC = () => {
  const navigation = useNavigation<any>();
  const [isStoryExpanded, setIsStoryExpanded] = useState(false);
  const { toggleSavedBar, isBarSaved } = useSavedItems();

  const barId = 'golden-era';
  const isSaved = isBarSaved(barId);

  const bar = {
    name: 'Golden Era',
    hero: {
      image: BAR_IMAGES.the_sapphire_chamber,
      location: 'Art Deco District'
    },
    quickInfo: {
      music: 'Live Jazz Performances',
      vibe: 'Vintage Cocktails',
      menu: '1920s Cocktails & Prohibition Era Bites',
      popularNights: 'Friday & Saturday',
      happyHour: 'Tuesday - Thursday 6-8 PM'
    },
    location: {
      address: '333 Queen Street West',
      city: 'Toronto, ON M5V 2A2',
      phone: '(416) 555-GOLDEN'
    }
  };

  const signatureDrinks = [
    { image: 'https://images.unsplash.com/photo-1541976076758-347942db1978?q=80&w=1200&auto=format&fit=crop', name: 'Bee\'s Knees', tagline: 'Gin & Honey Syrup', price: '$16' },
    { image: 'https://images.unsplash.com/photo-1541542684-4c7b4916e66e?q=80&w=1200&auto=format&fit=crop', name: 'Sidecar', tagline: 'Cognac & Cointreau', price: '$18' },
    { image: 'https://images.unsplash.com/photo-1497534547324-0ebb3f052e88?q=80&w=1200&auto=format&fit=crop', name: 'Mary Pickford', tagline: 'Rum & Pineapple', price: '$15' },
    { image: 'https://images.unsplash.com/photo-1560785496-3c9d27877182?q=80&w=1200&auto=format&fit=crop', name: 'Gin Rickey', tagline: 'Gin & Lime', price: '$14' },
  ];

  const events = [
    { title: 'Speakeasy Jazz Night', dateISO: '2024-03-21', time: '8:00 PM', city: 'Toronto' },
    { title: 'Vintage Cocktail Masterclass', dateISO: '2024-03-28', time: '7:00 PM', city: 'Toronto' },
  ];

  const story = {
    short: 'Step back in time to the glamorous 1920s. Golden Era captures the elegance and sophistication of the prohibition era with authentic vintage cocktails, jazz music, and timeless Art Deco design.',
    long: 'Step back in time to the glamorous 1920s. Golden Era captures the elegance and sophistication of the prohibition era with authentic vintage cocktails, jazz music, and timeless Art Deco design. Every detail has been carefully crafted to transport you to an era of speakeasies and secret cocktails, where the art of mixology was born from creativity and rebellion against prohibition.'
  };

  const handleShare = async () => {
    try {
      await Share.share({
        message: `Check out Golden Era! Vintage Cocktails - Step back in time to the glamorous 1920s with authentic prohibition era cocktails.`,
        title: `Golden Era - Premium Bar Experience`,
      });
    } catch (error) {
...
export default GoldenEraScreen;