...
const WhiskeyDenScreen: React.FC = () => {
  ...
  const bar = {
    ...
    quickInfo: {
      music: 'Live Jazz Tuesday & Wednesday',
      vibe: 'Premium Spirits',
      menu: 'Whiskey Collection & Steaks',
      popularNights: 'Friday & Saturday',
      happyHour: 'Thursday - Saturday 5-7 PM'
    },
    location: {
      address: '789 Heritage St, Heritage District',
      city: 'Toronto, ON M5V 3C0',
      phone: '(416) 555-WHSK'
    }
  };

  const signatureDrinks = [
    { image: 'https://images.unsplash.com/photo-1541976076758-347942db1978?q=80&w=1200&auto=format&fit=crop', name: 'Smoky Old Fashioned', tagline: 'Bourbon & Smoked Maple', price: '$18' },
    { image: 'https://images.unsplash.com/photo-1541542684-4c7b4916e66e?q=80&w=1200&auto=format&fit=crop', name: 'Rye Manhattan', tagline: 'Rye & Sweet Vermouth', price: '$16' },
    { image: 'https://images.unsplash.com/photo-1497534547324-0ebb3f052e88?q=80&w=1200&auto=format&fit=crop', name: 'Peated Scotch Neat', tagline: 'Islay Single Malt', price: '$22' },
    { image: 'https://images.unsplash.com/photo-1560785496-3c9d27877182?q=80&w=1200&auto=format&fit=crop', name: 'Whiskey Sour', tagline: 'Bourbon & Fresh Lemon', price: '$15' },
  ];

  const events = [
    { title: 'Whiskey Tasting Night', dateISO: '2024-03-17', time: '8:00 PM', city: 'Toronto' },
    { title: 'Live Jazz Evening', dateISO: '2024-03-24', time: '7:30 PM', city: 'Toronto' },
  ];

  const story = {
    short: 'Enter a world where whiskey is king at Whiskey Den, our tribute to the finest spirits from around the globe. Our carefully curated collection features rare bottles and premium pours in an atmosphere that honors tradition.',
    long: 'Enter a world where whiskey is king at Whiskey Den, our tribute to the finest spirits from around the globe. Our carefully curated collection features rare bottles and premium pours in an atmosphere that honors tradition. From smooth bourbons to peated Scotches, each pour tells a story of craftsmanship and heritage that spans generations.'
  };

  const handleShare = async () => {
    try {
      await Share.share({
        message: `Check out Whiskey Den! Premium Spirits - A unique whiskey experience with rare collections.`,
        title: `Whiskey Den - Premium Bar Experience`,
      });
    } catch (error) {
...
export default WhiskeyDenScreen;