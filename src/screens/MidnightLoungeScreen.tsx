...
const MidnightLoungeScreen: React.FC = () => {
  const navigation = useNavigation<any>();
  const [isStoryExpanded, setIsStoryExpanded] = useState(false);
  const { toggleSavedBar, isBarSaved } = useSavedItems();

  const barId = 'midnight-lounge';
  const isSaved = isBarSaved(barId);

  const bar = {
    name: 'Midnight Lounge',
    hero: {
      image: BAR_IMAGES.velvet_escape,
      location: 'Entertainment District'
    },
    quickInfo: {
      music: 'Live DJ & Ambient Music',
      vibe: 'Late Night Vibes',
      menu: 'Late Night Cocktails & Midnight Bites',
      popularNights: 'Friday & Saturday',
      happyHour: 'Wednesday - Thursday 10-12 PM'
    },
    location: {
      address: '222 Richmond Street West',
      city: 'Toronto, ON M5V 1V6',
      phone: '(416) 555-NIGHT'
    }
  };

  const signatureDrinks = [
    { image: 'https://images.unsplash.com/photo-1541976076758-347942db1978?q=80&w=1200&auto=format&fit=crop', name: 'Midnight Manhattan', tagline: 'Bourbon & Blackberry', price: '$17' },
    { image: 'https://images.unsplash.com/photo-1541542684-4c7b4916e66e?q=80&w=1200&auto=format&fit=crop', name: 'Night Owl', tagline: 'Gin & Absinthe', price: '$16' },
    { image: 'https://images.unsplash.com/photo-1497534547324-0ebb3f052e88?q=80&w=1200&auto=format&fit=crop', name: 'Dark Moon', tagline: 'Rum & Dark Chocolate', price: '$18' },
    { image: 'https://images.unsplash.com/photo-1560785496-3c9d27877182?q=80&w=1200&auto=format&fit=crop', name: 'After Hours', tagline: 'Vodka & Coffee Liqueur', price: '$15' },
  ];

  const events = [
    { title: 'Late Night DJ Sessions', dateISO: '2024-03-20', time: '11:00 PM', city: 'Toronto' },
    { title: 'Midnight Mixology', dateISO: '2024-03-27', time: '12:00 AM', city: 'Toronto' },
  ];

  const story = {
    short: 'When the night is young and the city never sleeps, Midnight Lounge is your destination. Dark, moody interiors paired with innovative late-night cocktails and small plates make this the perfect spot for night owls.',
    long: 'When the night is young and the city never sleeps, Midnight Lounge is your destination. Dark, moody interiors paired with innovative late-night cocktails and small plates make this the perfect spot for night owls. Our atmosphere embraces the mystery of the night, creating an intimate space where conversations flow as smoothly as our expertly crafted cocktails, long after the rest of the city has gone to sleep.'
  };

  const handleShare = async () => {
    try {
      await Share.share({
        message: `Check out Midnight Lounge! Late Night Vibes - Perfect for night owls seeking innovative cocktails and moody atmosphere.`,
        title: `Midnight Lounge - Premium Bar Experience`,
      });
    } catch (error) {
...
export default MidnightLoungeScreen;