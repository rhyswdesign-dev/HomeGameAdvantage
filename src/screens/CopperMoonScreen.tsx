...
const CopperMoonScreen: React.FC = () => {
  ...
  const bar = {
    ...
    quickInfo: {
      music: 'Live DJ Friday & Saturday',
      vibe: 'Industrial Chic',
      menu: 'Craft Cocktails & Premium Spirits',
      popularNights: 'Friday & Saturday',
      happyHour: 'Tuesday - Thursday 5-7 PM'
    },
    location: {
      address: '123 Industrial Way, Downtown District',
  ...
  const signatureDrinks = [
    { image: 'https://images.unsplash.com/photo-1541976076758-347942db1978?q=80&w=1200&auto=format&fit=crop', name: 'Copper Old Fashioned', tagline: 'Bourbon & Copper Bitters', price: '$16' },
    { image: 'https://images.unsplash.com/photo-1541542684-4c7b4916e66e?q=80&w=1200&auto=format&fit=crop', name: 'Industrial Mule', tagline: 'Vodka & Ginger', price: '$14' },
    { image: 'https://images.unsplash.com/photo-1497534547324-0ebb3f052e88?q=80&w=1200&auto=format&fit=crop', name: 'Moonlight Martini', tagline: 'Gin & Elderflower', price: '$15' },
    { image: 'https://images.unsplash.com/photo-1560785496-3c9d27877182?q=80&w=1200&auto=format&fit=crop', name: 'Steampunk Sour', tagline: 'Whiskey & Smoke', price: '$17' },
  ];

  const events = [
    { title: 'Live DJ Night', dateISO: '2024-03-15', time: '9:00 PM', city: 'Toronto' },
    { title: 'Cocktail Workshop', dateISO: '2024-03-22', time: '7:00 PM', city: 'Toronto' },
  ];

  const story = {
    short: 'Step into an industrial paradise where copper accents meet modern mixology. Our carefully curated cocktail menu features premium spirits in an atmosphere that perfectly balances raw industrial design with sophisticated comfort.',
    long: 'Step into an industrial paradise where copper accents meet modern mixology. Our carefully curated cocktail menu features premium spirits in an atmosphere that perfectly balances raw industrial design with sophisticated comfort. From exposed brick walls to gleaming copper fixtures, every detail creates an immersive experience that celebrates both heritage and innovation.'
  };

  const handleShare = async () => {
    try {
      await Share.share({
        message: `Check out Copper Moon! Industrial Chic - A unique cocktail experience with industrial design.`,
        title: `Copper Moon - Premium Bar Experience`,
      });
    } catch (error) {
...
export default CopperMoonScreen;